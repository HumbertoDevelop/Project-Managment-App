<div>
    <div class="container shadow-xl p-4 rounded-md bg-gray-200">
        ...
        <div class="grid grid-cols-1">
            <label>
                ...
                <textarea wire:model="description" placeholder="{{ __('Describe a task') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mb-4"></textarea>
            </label>
            @error('description')
        ...
        <x-button class="mt-4 block" wire:click="addTask">{{ __('Add Task') }}</x-button>
